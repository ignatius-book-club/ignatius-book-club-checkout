...
const getCustomerStepStatus = createSelector(
  ...
  (_checkout, _customer, _billingAddress, _config, _cart, _paymentProviderCustomer) => {
    return {
...
const getBillingStepStatus = createSelector(
  ...
  (_checkout, _billingAddress, _billingAddressFields) => {
    return {
...
const getShippingStepStatus = createSelector(
  ...
  ({ data }: CheckoutSelectors) => data.getConfig(),
  (_shippingAddress, _consignments, _cart, _shippingAddressFields, _config) => {
    return {
